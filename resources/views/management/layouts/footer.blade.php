                ...
                <div class="col-12 notification-nav-tabs">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" id="base-tab1" data-toggle="tab"
                                aria-controls="activity-tab" href="#activity-tab" aria-expanded="true">Activity</a></li>
                                ...
                                <div class="timeline-left timeline-wrapper mb-3" id="timeline-1">
                                    <ul class="timeline">
                                        ...
                                        <li class="timeline-item">
                                            <div class="timeline-badge"><span class="bg-primary bg-lighten-4"
                                                    data-toggle="tooltip" data-placement="right"
                                                    title="Portfolio project work"><i class="ft-mic primary"></i></span>
                                            </div>
                                            <div class="activity-list-text">
                                        ...
                                        <li class="timeline-item">
                                            ...
                                            <div class="activity-list-text">
                                                ...
                                                <p class="mt-0 mb-2 font-small-3">Victoria Hampton sent you a mail and
                                                    has
                                                    a file attachment with it.</p>
                                                <div class="notification-note">
                                                    <div class="p-1 pl-2"><img
                                                            src="../../../app-assets/img/icons/pdf.png" alt="pdf icon"
                                                            width="20"><span
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="{{ asset('management/app-assets/vendors/js/vendors.min.js') }}"></script>
    <script src="{{ asset('management/app-assets/vendors/js/switchery.min.js') }}"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    {{-- <script src="{{asset('management/app-assets/vendors/js/chartist.min.js')}}"></script> --}}
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN APEX JS-->
    <script src="{{ asset('management/app-assets/js/core/app-menu.js') }}"></script>
    <script src="{{ asset('management/app-assets/js/core/app.js') }}"></script>
