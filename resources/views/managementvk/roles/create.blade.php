...
{!! Form::open(array('route' => 'roles.store','method'=>'POST','id'=>'subm')) !!}
                ...
                @if($value->parent_id === null)
                    ...
                    <div class="permission-container">
                        <div class="custom-accordion row py-0">
                            <label class="col-11 py-2 text-capitalize">{{ Form::checkbox('permission[]', $value->name, false, array('class' => 'parent')) }}
                        ...
                        <div class="sub-permissions" style="display: none">
                            @foreach($permission as $subPermission)
                                @if($subPermission->parent_id == $value->id)
                                    <label class="pl-5 py-2">{{ Form::checkbox('permission[]', $subPermission->name, false, array('class' => 'child')) }}
