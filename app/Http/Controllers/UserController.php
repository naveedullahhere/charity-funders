...
class UserController extends Controller
{
    ...
    {
        return view('management.users.profileSetting');
    }
...
//    }
    ...
    public function profileSettingUpdate(Request $request, $id)
    {
        ...
        try {
            if ($request->file('profile_image')) {
                // Generate a unique file name with a slug, random string, and timestamp
                $slug = Str::slug($user->name);
                $randomString = Str::random(6);
                $timestamp = time();
                $extension = $request->profile_image->extension();
                $imageName = "{$slug}-{$randomString}-{$timestamp}.{$extension}";
            ...
            if (isset($imageName)) {
                $requestData['profile_image'] = 'users/' . $imageName;
            }
    ...
    public function getTable(Request $request)
    {
        ...
        return view('management.users.getList', compact('users'));
    }
