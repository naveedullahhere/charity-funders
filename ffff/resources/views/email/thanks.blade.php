                                            ...
                                            <tr>
                                                <td style="padding:0 35px;">
                                                    <h1
                                                        ...
                                                        Hi {{ $booking['first_name'] . ' ' . $booking['last_name'] }},</h1>
                                                    <p
                                                        style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                                        Thank you for booking with us.</p>
                                                    <p
                                                        style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                                        You can view your invoice by clicking the link below:</p>
                                                    <a href="{{ url('/thank-you', $booking['inv_id']) }}"
                                                        style="background: #0a4171;text-decoration:none !important;display:inline-block;font-weight:500;margin-top:24px;color:#fff;text-transform:uppercase;font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">View
                                                        Booking Details</a>
                                                </td>
                                            </tr>
