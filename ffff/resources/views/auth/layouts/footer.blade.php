...
<section class="py-5">
    <div class="container">
        <div class="row line-pattern bg-primary-gradient rounded-3 p-7 g-0">
            <div
                class="col-xl-8 col-lg-10 col-md-12 col-12 mx-auto">
                <div class="position-relative z-1 my-lg-5">
                    <div class="mb-5 text-center">
                        <h3 class="h2 text-white-stable mb-1">Try our
                            powerful work management tools</h3>
                        <p class="mb-0 text-white-stable">Sign up for a free
                            two-week trial of Block today — no credit card
                            required.</p>
                    </div>
                    <form class="row g-2 needs-validation d-flex mx-lg-7 from-newsllter" id="newsletter" action="newsletter.php" method="post" novalidate>
                        <div class="col-md-4 col-xl-4 col-12">
                            <label for="notificationEmail"
                                   class="visually-hidden"></label>
                            <input type="text" id="notificationEmail"
                                   class="form-control"
        ...
        <div class="row">
            <div class="col-xxl-5 col-lg-5 col-md-7">
                <div class="mb-7 mb-xl-0">
                    <div class="mb-4">
                        <a href="#">
                            <img src="images/logo1-1.png" alt="logo" class="text-inverse" />
                        </a>
                    </div>
                    <h5 class="mb-3">Concerns or questions?</h5>
                    <p class="mb-5">The most common questions we are asked can be found on our FAQS page.</p>
                ...
                <div class="row" id="ft-links">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="collapse d-lg-block" id="collapseLanding" data-bs-parent="#ft-links">
                                <ul class="list-unstyled mb-0 py-3 py-lg-0">
                                    ...
                                    <li class="mb-2">
                                        <a href="../landing-finance.html" class="text-decoration-none text-reset">FAQ</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="../landing-jamstack-agancy.html" class="text-decoration-none text-reset">Meet & Greet</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="terms.php" class="text-decoration-none text-reset">Terms & Conditions</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="collapse d-lg-block" id="collapseAccounts" data-bs-parent="#ft-links">
                            ...
                            <ul class="list-unstyled mb-0 py-3 py-lg-0">
                                <li class="mb-2"><a class="text-decoration-none text-reset" href="aberdeen-airport-parking.php">Aberdeen Airport</a> </li>
                                <li class="mb-2"><a class="text-decoration-none text-reset" href="birmingham-airport-parking.php">Birmingham Airport</a> </li>
                                <li class="mb-2"><a class="text-decoration-none text-reset" href="gatwick-airport-parking.php">Gatwick Airport</a> </li>
                                <li class="mb-2"><a class="text-decoration-none text-reset" href="heathrow-airport-parking.php">Heathrow Airport</a> </li>
                                <li class="mb-2"><a class="text-decoration-none text-reset" href="leeds-bradford-airport-parking.php">Leeds-Bradford Airport</a> </li>
                            </ul>
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="collapse d-lg-block" id="collapseResources" data-bs-parent="#ft-links">
                            <div class="partners m-0 ">
                                <a  href="http://www.parkmark.co.uk/" target="_blank"><img src="images/park-mark.jpg" alt="Park Mark Members"></a>
                                <a href="/"><img src="images/20-years-of-service.jpg" alt="Over 20 years of service"></a>         </div>
                        </div>
                    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-9">
                <div class="small mb-3 mb-md-0">
                    Copyright © 2024
                    <span class="text-primary"><a href="#">Air Parking Services</a></span>
                </div>
            </div>
            <div class="col-md-3">
